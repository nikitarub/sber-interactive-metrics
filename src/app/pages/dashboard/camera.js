...
import {drawBoundingBox, drawKeypoints, drawSkeleton, isMobile, toggleLoadingUI, checkWaveWrist} from './demo_util';
...
function detectPoseInRealTime(video, net) {
    ...
    async function poseDetectionFrame() {
        ...
        case 'single-pose':
            ...
            break;
        case 'multi-pose':
            const all_poses = await guiState.net.estimatePoses(video, {
                flipHorizontal: flipPoseHorizontal,
        ...
        poses.forEach(({score, keypoints}) => {
            if (score >= minPoseConfidence) {
                if (guiState.output.showPoints) {
                    ...
                    checkWaveWrist(keypoints, minPartConfidence);
                }
